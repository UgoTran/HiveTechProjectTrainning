package hivetech.jdbctransaction.demo;
...
public class JDBC_Transaction_demo {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            myConn = DriverManager.getConnection("jdbc:mariadb://localhost:3306/demo_transaction", "root", "root");
            ...
            System.out.println("** After execute DELETE & UPDATE\n");
            showSalaries(myConn, "HR");
            showSalaries(myConn, "Engineering");
    ...
    private static boolean askUserIfOkToSave() {
        ...
        System.out.print("Is it okay to save? Y/N: ");
